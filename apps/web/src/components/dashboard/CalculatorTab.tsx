          ...
          {(invest?.byBedrooms ?? [])
            ...
            .map((b) => {
              ...
              return (
                ...
                >
                  <p className="text-[15px] font-bold" style={{ color: active ? UI.green : UI.text }}>
                    {b.label}
                  </p>
                  <p className="text-[15px] font-semibold" style={{ color: UI.text }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5 mt-2.5">
        ...
        <div className="glass-card rounded-2xl p-5">
          ...
          >
            ...
            <p className="text-[15px] mt-1.5" style={{ color: UI.muted }}>
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-3 mt-5">
            <div>
              <p className="text-[12px] uppercase tracking-wider font-medium" style={{ color: UI.muted }}>Gross revenue</p>
              <p className="text-sm font-bold" style={{ color: UI.text }}>{fmtEuro(Math.round(calc.gross))}/yr</p>
            </div>
            <div>
              <p className="text-[12px] uppercase tracking-wider font-medium" style={{ color: UI.muted }}>All costs</p>
              <p className="text-sm font-bold" style={{ color: UI.text }}>
                {fmtEuro(Math.round(calc.variable + fixed + calc.mortgage))}/yr
              </p>
            </div>
            <div>
              <p className="text-[12px] uppercase tracking-wider font-medium" style={{ color: UI.muted }}>
            ...
            <div>
              <p className="text-[12px] uppercase tracking-wider font-medium" style={{ color: UI.muted }}>Money back in</p>
              <p className="text-sm font-bold" style={{ color: UI.text }}>
          ...
          <div className="mt-5">
            <p className="text-[13px] font-semibold uppercase tracking-wider mb-2" style={{ color: UI.muted }}>
              Where the revenue goes
            </p>
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2">
              ...
              {loss > 0 && (
                <span className="text-[13px] font-semibold" style={{ color: NEG }}>
          ...
          {calc.occNeeded != null && (
            <div
              className="flex items-start gap-2 rounded-xl px-3.5 py-3 mt-5 text-[14px] leading-relaxed"
          ...
          {ltrYear != null && (
            <p className="text-[14px] mt-3.5" style={{ color: UI.faint }}>
